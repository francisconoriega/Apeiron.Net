...
namespace Apeiron.Core
{
    public class Combinador
    {
        ...
        private List<string> filtroCentros;
        private ILookup<string, string> filtroMaestros;
        private bool soloConCupo;
        private bool permiteHorariosIncompletos;

        public List<CombinacionGrupos> EncuentraTodos(List<Materia> materias, ILookup<string, string> filtroMaestros, TimeSpan maxDuracionPorHueco, List<string> filtroCentros = null, int maxHuecosPorDia = int.MaxValue, bool soloConCupo = true, bool permiteHorariosIncompletos = true)
        {
            this.numCiclos = 0;
