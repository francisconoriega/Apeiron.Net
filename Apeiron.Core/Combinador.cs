...
namespace Apeiron.Core
{
    public class Combinador
    {
        ...
        public List<CombinacionGrupos> EncuentraTodos(List<Materia> materias, ILookup<string, string> filtroMaestros, TimeSpan maxDuracionPorHueco, HashSet<string> filtroCentros = null, int maxHuecosPorDia = int.MaxValue, bool soloConCupo = true, bool permiteHorariosIncompletos = true)
        {
            this.numCiclos = 0;
